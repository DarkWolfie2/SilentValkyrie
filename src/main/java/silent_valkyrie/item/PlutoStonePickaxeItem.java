...
public class PlutoStonePickaxeItem extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:pluto_stone_pickaxe")
	...
	public void initElements() {
		elements.items.add(() -> new PickaxeItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("A Pickaxe made from The Dwarf Planet Pluto"));
			}
		}.setRegistryName("pluto_stone_pickaxe"));
	}
}
