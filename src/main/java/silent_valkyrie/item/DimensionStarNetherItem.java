...
public class DimensionStarNetherItem extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:dimension_star_nether")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("dimension_star_nether");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("The Heart of the Nether"));
		}
	}
}
