...
public class MoltenPlutoSteelItem extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:molten_pluto_steel")
	public static final Item block = null;

	public MoltenPlutoSteelItem(SilentValkyrieModElements instance) {
		super(instance, 73);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("molten_pluto_steel");
		}
