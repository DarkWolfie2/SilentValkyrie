...
public class CryptoniumItem extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:cryptonium")
	public static final Item block = null;

	public CryptoniumItem(SilentValkyrieModElements instance) {
		super(instance, 77);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("The Silent Valyrie's Weakness"));
		}
	}
}
