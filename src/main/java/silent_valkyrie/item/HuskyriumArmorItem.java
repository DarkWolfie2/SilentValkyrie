...
public class HuskyriumArmorItem extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:huskyrium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("silent_valkyrie:huskyrium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("silent_valkyrie:huskyrium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("silent_valkyrie:huskyrium_armor_boots")
