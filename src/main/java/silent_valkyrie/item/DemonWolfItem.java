...
public class DemonWolfItem extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:demon_wolf")
	public static final Item block = null;

	public DemonWolfItem(SilentValkyrieModElements instance) {
		super(instance, 81);
	}
