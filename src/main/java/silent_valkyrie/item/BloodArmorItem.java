...
public class BloodArmorItem extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:blood_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("silent_valkyrie:blood_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("silent_valkyrie:blood_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("silent_valkyrie:blood_armor_boots")
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{2, 3, 8, 3}[slot.getIndex()];
			}
