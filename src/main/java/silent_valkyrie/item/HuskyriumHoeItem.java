...
public class HuskyriumHoeItem extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:huskyrium_hoe")
	public static final Item block = null;

	public HuskyriumHoeItem(SilentValkyrieModElements instance) {
		super(instance, 36);
	}
