...
public class TitaniumArmorItem extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:titanium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("silent_valkyrie:titanium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("silent_valkyrie:titanium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("silent_valkyrie:titanium_armor_boots")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(SilentValkItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "silent_valkyrie:textures/models/armor/titanium__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
