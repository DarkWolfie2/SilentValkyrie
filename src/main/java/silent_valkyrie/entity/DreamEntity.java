...
import silent_valkyrie.item.HuskyriumSwordItem;

import silent_valkyrie.entity.renderer.DreamRenderer;
...
public class DreamEntity extends SilentValkyrieModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("dream").setRegistryName("dream");

	public DreamEntity(SilentValkyrieModElements instance) {
		super(instance, 3);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DreamRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16738048, new Item.Properties().group(SilentValkAddonsItemGroup.tab))
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(HuskyriumSwordItem.block));
		}
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(3, new RandomWalkingGoal(this, 0.45));
			this.targetSelector.addGoal(4, new HurtByTargetGoal(this));
			this.goalSelector.addGoal(5, new BreakBlockGoal(Blocks.DIAMOND_ORE, this, 1, (int) 3));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(PlutoStoneItem.block));
		}

		@Override
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.drowned.ambient"));
		}
