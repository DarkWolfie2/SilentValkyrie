...
import silent_valkyrie.entity.renderer.DistortedCowRenderer;
...
public class DistortedCowEntity extends SilentValkyrieModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.4f)).build("distorted_cow").setRegistryName("distorted_cow");

	public DistortedCowEntity(SilentValkyrieModElements instance) {
		super(instance, 8);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DistortedCowRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -65281, -10092442, new Item.Properties().group(SilentValkAddonsItemGroup.tab))
				.setRegistryName("distorted_cow_spawn_egg"));
	}
