...
public class ValkyrieWoodSlabBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:valkyrie_wood_slab")
	public static final Block block = null;

	public ValkyrieWoodSlabBlock(SilentValkyrieModElements instance) {
		super(instance, 105);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("valkyrie_wood_slab");
		}
