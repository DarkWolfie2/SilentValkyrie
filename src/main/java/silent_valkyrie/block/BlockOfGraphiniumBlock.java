...
public class BlockOfGraphiniumBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:block_of_graphinium")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("block_of_graphinium");
		}
