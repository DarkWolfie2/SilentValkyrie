...
public class HuskyriumOreBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:huskyrium_ore")
	public static final Block block = null;

	public HuskyriumOreBlock(SilentValkyrieModElements instance) {
		super(instance, 80);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("silent_valkyrie:huskyrium_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("huskyrium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("silent_valkyrie:huskyrium_ore"), configuredFeature);
		}
	}
