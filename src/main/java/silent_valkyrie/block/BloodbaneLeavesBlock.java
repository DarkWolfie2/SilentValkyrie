...
public class BloodbaneLeavesBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:bloodbane_leaves")
	public static final Block block = null;

	public BloodbaneLeavesBlock(SilentValkyrieModElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("bloodbane_leaves");
		}
