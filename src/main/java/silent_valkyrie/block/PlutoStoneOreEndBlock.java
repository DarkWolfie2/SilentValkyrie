...
public class PlutoStoneOreEndBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:pluto_stone_ore_end")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pluto_stone_ore_end");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MoltenPlutoSteelItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("silent_valkyrie:pluto_stone_ore_end_match"),
