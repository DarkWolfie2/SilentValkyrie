...
public class PlutoWoodLeavesBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:pluto_wood_leaves")
	public static final Block block = null;

	public PlutoWoodLeavesBlock(SilentValkyrieModElements instance) {
		super(instance, 124);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("pluto_wood_leaves");
		}
