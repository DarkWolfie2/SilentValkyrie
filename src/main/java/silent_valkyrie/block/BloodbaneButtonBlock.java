...
public class BloodbaneButtonBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:bloodbane_button")
	public static final Block block = null;

	public BloodbaneButtonBlock(SilentValkyrieModElements instance) {
		super(instance, 129);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("bloodbane_button");
		}
