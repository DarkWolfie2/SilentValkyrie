...
public class BloodbanePlanksBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:bloodbane_planks")
	public static final Block block = null;

	public BloodbanePlanksBlock(SilentValkyrieModElements instance) {
		super(instance, 124);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bloodbane_planks");
		}
