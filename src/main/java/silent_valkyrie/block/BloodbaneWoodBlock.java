...
public class BloodbaneWoodBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:bloodbane_wood")
	public static final Block block = null;

	public BloodbaneWoodBlock(SilentValkyrieModElements instance) {
		super(instance, 124);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("bloodbane_wood");
		}
