...
public class ValkyrieWoodLeavesBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:valkyrie_wood_leaves")
	public static final Block block = null;

	public ValkyrieWoodLeavesBlock(SilentValkyrieModElements instance) {
		super(instance, 110);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("valkyrie_wood_leaves");
		}
