...
import silent_valkyrie.item.BloodDustDustItem;
...
public class BloodDustOreBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:blood_dust_ore")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blood_dust_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BloodDustDustItem.block, (int) (3)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("silent_valkyrie:blood_dust_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("blood_dust_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("silent_valkyrie:blood_dust_ore"), configuredFeature);
		}
	}
