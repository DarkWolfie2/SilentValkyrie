...
public class PlutoWoodPlanksBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:pluto_wood_planks")
	public static final Block block = null;

	public PlutoWoodPlanksBlock(SilentValkyrieModElements instance) {
		super(instance, 114);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pluto_wood_planks");
		}
