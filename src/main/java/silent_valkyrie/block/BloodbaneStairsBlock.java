...
public class BloodbaneStairsBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:bloodbane_stairs")
	public static final Block block = null;

	public BloodbaneStairsBlock(SilentValkyrieModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("bloodbane_stairs");
		}
