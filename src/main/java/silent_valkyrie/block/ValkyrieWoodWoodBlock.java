...
public class ValkyrieWoodWoodBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:valkyrie_wood_wood")
	public static final Block block = null;

	public ValkyrieWoodWoodBlock(SilentValkyrieModElements instance) {
		super(instance, 104);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("valkyrie_wood_wood");
		}
