...
public class ValkyrieWoodPlanksBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:valkyrie_wood_planks")
	public static final Block block = null;

	public ValkyrieWoodPlanksBlock(SilentValkyrieModElements instance) {
		super(instance, 103);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("valkyrie_wood_planks");
		}
