...
public class BloodbaneFenceBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:bloodbane_fence")
	public static final Block block = null;

	public BloodbaneFenceBlock(SilentValkyrieModElements instance) {
		super(instance, 128);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("bloodbane_fence");
		}
