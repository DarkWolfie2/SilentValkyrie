...
public class BloodbaneLogBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:bloodbane_log")
	public static final Block block = null;

	public BloodbaneLogBlock(SilentValkyrieModElements instance) {
		super(instance, 127);
	}
