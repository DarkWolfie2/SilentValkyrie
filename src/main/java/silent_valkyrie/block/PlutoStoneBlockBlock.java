...
public class PlutoStoneBlockBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:pluto_stone_block")
	public static final Block block = null;

	public PlutoStoneBlockBlock(SilentValkyrieModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pluto_stone_block");
		}
