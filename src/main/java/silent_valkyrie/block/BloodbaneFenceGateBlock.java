...
public class BloodbaneFenceGateBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:bloodbane_fence_gate")
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("bloodbane_fence_gate");
		}
