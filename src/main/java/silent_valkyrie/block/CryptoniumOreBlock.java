...
import silent_valkyrie.item.CryptoniumItem;
...
public class CryptoniumOreBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:cryptonium_ore")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cryptonium_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CryptoniumItem.block, (int) (2)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("silent_valkyrie:cryptonium_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("cryptonium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("silent_valkyrie:cryptonium_ore"), configuredFeature);
		}
	}
