...
public class BloodDustBlockBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:blood_dust_block")
	public static final Block block = null;

	public BloodDustBlockBlock(SilentValkyrieModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blood_dust_block");
		}
