...
public class PlutoWoodButtonBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:pluto_wood_button")
	public static final Block block = null;

	public PlutoWoodButtonBlock(SilentValkyrieModElements instance) {
		super(instance, 117);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("pluto_wood_button");
		}
