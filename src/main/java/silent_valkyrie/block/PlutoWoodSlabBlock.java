...
public class PlutoWoodSlabBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:pluto_wood_slab")
	public static final Block block = null;

	public PlutoWoodSlabBlock(SilentValkyrieModElements instance) {
		super(instance, 119);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("pluto_wood_slab");
		}
