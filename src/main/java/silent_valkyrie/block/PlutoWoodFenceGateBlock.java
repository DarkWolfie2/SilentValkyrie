...
public class PlutoWoodFenceGateBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:pluto_wood_fence_gate")
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("pluto_wood_fence_gate");
		}
