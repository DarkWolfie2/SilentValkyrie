...
public class PlutoWoodStairsBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:pluto_wood_stairs")
	public static final Block block = null;

	public PlutoWoodStairsBlock(SilentValkyrieModElements instance) {
		super(instance, 118);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("pluto_wood_stairs");
		}
