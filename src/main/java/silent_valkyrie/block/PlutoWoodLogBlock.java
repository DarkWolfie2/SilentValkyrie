...
public class PlutoWoodLogBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:pluto_wood_log")
	public static final Block block = null;

	public PlutoWoodLogBlock(SilentValkyrieModElements instance) {
		super(instance, 115);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("pluto_wood_log");
		}
