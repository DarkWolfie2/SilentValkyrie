...
public class ValkyrieWoodButtonBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:valkyrie_wood_button")
	public static final Block block = null;

	public ValkyrieWoodButtonBlock(SilentValkyrieModElements instance) {
		super(instance, 106);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("valkyrie_wood_button");
		}
