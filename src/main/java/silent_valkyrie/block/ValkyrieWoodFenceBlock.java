...
public class ValkyrieWoodFenceBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:valkyrie_wood_fence")
	public static final Block block = null;

	public ValkyrieWoodFenceBlock(SilentValkyrieModElements instance) {
		super(instance, 107);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("valkyrie_wood_fence");
		}
