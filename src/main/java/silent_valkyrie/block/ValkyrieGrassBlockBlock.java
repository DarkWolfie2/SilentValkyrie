...
public class ValkyrieGrassBlockBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:valkyrie_grass_block")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("valkyrie_grass_block");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("silent_valkyrie:valkyrie_grass_block_match"),
			...
			event.getRegistry().register(feature.setRegistryName("valkyrie_grass_block"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("silent_valkyrie:valkyrie_grass_block"), configuredFeature);
		}
	}
