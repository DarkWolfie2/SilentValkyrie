...
public class ValkyriumOreBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:valkyrium_ore")
	public static final Block block = null;

	public ValkyriumOreBlock(SilentValkyrieModElements instance) {
		super(instance, 83);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("silent_valkyrie:valkyrium_ore_match"),
