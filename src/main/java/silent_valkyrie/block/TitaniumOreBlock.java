...
public class TitaniumOreBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:titanium_ore")
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TitaniumIngotItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("silent_valkyrie:titanium_ore_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 1)).range(26)
					.square().func_242731_b(2);
			event.getRegistry().register(feature.setRegistryName("titanium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("silent_valkyrie:titanium_ore"), configuredFeature);
		}
	}
