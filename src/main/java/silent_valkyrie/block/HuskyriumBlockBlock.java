...
public class HuskyriumBlockBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:huskyrium_block")
	public static final Block block = null;

	public HuskyriumBlockBlock(SilentValkyrieModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("huskyrium_block");
		}
