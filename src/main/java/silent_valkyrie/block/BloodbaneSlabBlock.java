...
public class BloodbaneSlabBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:bloodbane_slab")
	public static final Block block = null;

	public BloodbaneSlabBlock(SilentValkyrieModElements instance) {
		super(instance, 129);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("bloodbane_slab");
		}
