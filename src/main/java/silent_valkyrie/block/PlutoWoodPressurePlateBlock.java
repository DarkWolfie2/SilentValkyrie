...
public class PlutoWoodPressurePlateBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:pluto_wood_pressure_plate")
	public static final Block block = null;

	public PlutoWoodPressurePlateBlock(SilentValkyrieModElements instance) {
		super(instance, 122);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("pluto_wood_pressure_plate");
		}
