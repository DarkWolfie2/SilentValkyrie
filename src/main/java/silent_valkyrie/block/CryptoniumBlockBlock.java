...
public class CryptoniumBlockBlock extends SilentValkyrieModElements.ModElement {
	@ObjectHolder("silent_valkyrie:cryptonium_block")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cryptonium_block");
		}
