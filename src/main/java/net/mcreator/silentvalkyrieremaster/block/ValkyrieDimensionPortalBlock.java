...
package net.mcreator.silentvalkyrieremaster.block;
...
import net.mcreator.silentvalkyrieremaster.world.teleporter.ValkyrieDimensionTeleporter;
import net.mcreator.silentvalkyrieremaster.world.teleporter.ValkyrieDimensionPortalShape;
import net.mcreator.silentvalkyrieremaster.init.SilentvalkyrieremasterModBlocks;

import java.util.Random;
import java.util.Optional;

public class ValkyrieDimensionPortalBlock extends NetherPortalBlock {
	public ValkyrieDimensionPortalBlock() {
	...
	public static void portalSpawn(Level world, BlockPos pos) {
		Optional<ValkyrieDimensionPortalShape> optional = ValkyrieDimensionPortalShape.findEmptyPortalShape(world, pos, Direction.Axis.X);
	...
	public BlockState updateShape(BlockState p_54928_, Direction p_54929_, BlockState p_54930_, LevelAccessor p_54931_, BlockPos p_54932_,
		...
		return !flag && !p_54930_.is(this) && !(new ValkyrieDimensionPortalShape(p_54931_, p_54932_, direction$axis1)).isComplete()
		...
		if (!entity.isPassenger() && !entity.isVehicle() && entity.canChangeDimensions() && !entity.level.isClientSide() && true) {
			if (entity.isOnPortalCooldown()) {
				entity.setPortalCooldown();
					...
					new ResourceLocation("silentvalkyrieremaster:valkyrie_dimension"))) {
				entity.setPortalCooldown();
	...
	private void teleportToDimension(Entity entity, BlockPos pos, ResourceKey<Level> destinationType) {
		entity.changeDimension(entity.getServer().getLevel(destinationType),
				new ValkyrieDimensionTeleporter(entity.getServer().getLevel(destinationType), pos));
	}

	@OnlyIn(Dist.CLIENT)
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(SilentvalkyrieremasterModBlocks.VALKYRIE_DIMENSION_PORTAL.get(),
