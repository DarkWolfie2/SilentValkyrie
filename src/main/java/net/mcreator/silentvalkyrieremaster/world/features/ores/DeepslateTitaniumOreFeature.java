...
public class DeepslateTitaniumOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("silentvalkyrieremaster:deepslate_titanium_ore", FEATURE, new OreConfiguration(
				DeepslateTitaniumOreFeatureRuleTest.INSTANCE, SilentvalkyrieremasterModBlocks.DEEPSLATE_TITANIUM_ORE.get().defaultBlockState(), 4));
		PLACED_FEATURE = PlacementUtils.register("silentvalkyrieremaster:deepslate_titanium_ore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(2), InSquarePlacement.spread(),
						HeightRangePlacement.uniform(VerticalAnchor.absolute(-34), VerticalAnchor.absolute(-13)), BiomeFilter.biome()));
		return FEATURE;
	}
	...
	private static class DeepslateTitaniumOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("silentvalkyrieremaster:deepslate_titanium_ore_match"), CUSTOM_MATCH);
		}
