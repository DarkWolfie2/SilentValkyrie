...
public abstract class DemonWolfArmorItem extends ArmorItem {
	public DemonWolfArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends DemonWolfArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "silentvalkyrieremaster:textures/models/armor/demonwolf__layer_1.png";
		}
	}

	public static class Chestplate extends DemonWolfArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends DemonWolfArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "silentvalkyrieremaster:textures/models/armor/demonwolf__layer_2.png";
		}
	}

	public static class Boots extends DemonWolfArmorItem {
		public Boots() {
