...
public class SilentRedemption2Item extends RecordItem {
	public SilentRedemption2Item() {
		super(0, SilentvalkyrieremasterModSounds.REGISTRY.get(new ResourceLocation("silentvalkyrieremaster:silentredemption")),
