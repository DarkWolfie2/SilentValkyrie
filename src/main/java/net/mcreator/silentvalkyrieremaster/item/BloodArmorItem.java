...
public abstract class BloodArmorItem extends ArmorItem {
	public BloodArmorItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(SilentvalkyrieremasterModItems.BLOOD_DUST.get()));
			}
	...
	public static class Helmet extends BloodArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "silentvalkyrieremaster:textures/models/armor/blood__layer_1.png";
		}
	}
	...
	public static class Leggings extends BloodArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "silentvalkyrieremaster:textures/models/armor/blood__layer_2.png";
		}
	}
