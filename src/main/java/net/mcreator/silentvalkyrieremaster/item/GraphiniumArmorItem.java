...
public abstract class GraphiniumArmorItem extends ArmorItem {
	public GraphiniumArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends GraphiniumArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "silentvalkyrieremaster:textures/models/armor/graphinium__layer_1.png";
		}
	}

	public static class Chestplate extends GraphiniumArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends GraphiniumArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "silentvalkyrieremaster:textures/models/armor/graphinium__layer_2.png";
		}
	}

	public static class Boots extends GraphiniumArmorItem {
		public Boots() {
