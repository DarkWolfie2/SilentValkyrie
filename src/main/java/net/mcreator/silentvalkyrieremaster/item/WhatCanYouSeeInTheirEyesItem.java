...
public class WhatCanYouSeeInTheirEyesItem extends RecordItem {
	public WhatCanYouSeeInTheirEyesItem() {
		super(0, SilentvalkyrieremasterModSounds.REGISTRY.get(new ResourceLocation("silentvalkyrieremaster:whatcanyouseeintheireyes")),
