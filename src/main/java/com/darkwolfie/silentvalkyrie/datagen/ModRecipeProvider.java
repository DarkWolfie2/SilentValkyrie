...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    private static final List<ItemLike> ORE_SMELTABLES = List.of(ModItems.MOLTEN_PLUTOSTEEL.get(),
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        oreBlasting(pWriter, ORE_SMELTABLES, RecipeCategory.MISC, ModItems.HARDENED_PLUTOSTEEL.get(), 0.25f, 100, "ores_molten");
        oreSmelting(pWriter, ORE_SMELTABLES, RecipeCategory.MISC, ModItems.HARDENED_PLUTOSTEEL.get(), 0.25f, 100, "ores_molten");
    }
